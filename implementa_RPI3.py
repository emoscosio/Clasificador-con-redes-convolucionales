...
# Nombre del archivo:
nombre = "" ## PONER DIRECCIÓN EN DISCO DE RED NEURONAL ENTRE ""
...
# Imprime la clase predicha y la imagen original:
print("Numero de imagenes totales: ", img_totales)
print("Numero de imagenes bien clasificadas: ", numero_imagenes)
